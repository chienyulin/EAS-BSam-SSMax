function [ad_map, qdm_report] = EAS_ISSMax(HIM,GT,para_set)
% 
% EAS-ISSMax implementation
%
% INPUTS:
...
HIM_feedback = cat(3,HIM_feedback,max_map);

% add back to the original cube
HIM_pro = cat(3,HIM,HIM_feedback);
